        ...
        <div className="relative">
          ...
          >
            ...
            <Generating
              ...
              border border-n-1/10 lg:left-1/2 lg:right-auto lg:bottom-8 
            lg:-translate-x-1/2"
            />
          </div>
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            ...
            >
              ...
              >
                ...
                <p className="body-2 mb-[3rem] text-n-3">
                  Automatically enhance your photos using Brainwave&apos;s photo
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
              <div className="py-12 px-4 xl:px-8">
                ...
                <p className="body-2 mb-[2rem] text-n-3">
                  The world&apos;s post powerful AI photo and video generation
                    ...
                    <li
                      ...
                      className={`flex items-center justify-center ${
                        index === 2
                          ...
                          : "flex w-10 h-10 bg-n-6 rounded-2xl md:w-15 m:h-15"
                      }`}
                    >
                      <div
                        className={
